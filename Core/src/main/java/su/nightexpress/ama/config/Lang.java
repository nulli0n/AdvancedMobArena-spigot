...
public class Lang extends EngineLang {
	...
	@Deprecated public static final LangKey Shop_Notify_NewItems     = new LangKey("Shop.Notify.NewItems", "&aNew items appeared in the shop!");
	@Deprecated public static final LangKey Shop_Buy_Success         = new LangKey("Shop.Buy.Success", "You successfully bought &a%shop_product_name% &7for &a%shop_product_price%7!");
	@Deprecated public static final LangKey Shop_Buy_Error_NoMoney   = new LangKey("Shop.Buy.Error.NoMoney", "&cYou don't have enough money to buy &e%shop_product_name%&c!");
	@Deprecated public static final LangKey Shop_Buy_Error_Locked    = new LangKey("Shop.Buy.Error.Locked", "&cThis item is not available yet!");
	@Deprecated public static final LangKey Shop_Buy_Error_BadKit    = new LangKey("Shop.Buy.Error.BadKit", "&cThis item is not available for your kit!");
