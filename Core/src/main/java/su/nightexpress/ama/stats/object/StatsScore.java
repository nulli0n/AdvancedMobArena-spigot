...
public class StatsScore implements IPlaceholder {
    ...
    public UnaryOperator<String> replacePlaceholders() {
        return str -> str
            .replace(Placeholders.STATS_SCORE_AMOUNT, String.valueOf(this.getScore()))
            .replace(Placeholders.STATS_SCORE_NAME, this.getName())
            .replace(Placeholders.STATS_SCORE_TYPE, ArenaAPI.PLUGIN.getLangManager().getEnum(this.getStatType()))
            ;
    }
