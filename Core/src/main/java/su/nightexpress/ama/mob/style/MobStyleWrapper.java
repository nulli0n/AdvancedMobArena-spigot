...
public class MobStyleWrapper<E, T> {
    ...
    public MobStyleWrapper(@NotNull Class<E> entityClass, @NotNull MobStyleWriter<E, T> writer) {
    ...
    public final boolean apply(@NotNull LivingEntity entity, @NotNull String value) {
    ...
    public static final MobStyleWrapper<Cat, Cat.Type> CAT_TYPE = new MobStyleWrapper<>(Cat.class, new MobStyleWriter.WriterEnum<Cat, Cat.Type>() {
        @NotNull
        @Override
    ...
    public static final MobStyleWrapper<Villager, Villager.Profession> VILLAGER = new MobStyleWrapper<>(Villager.class, new MobStyleWriter.WriterEnum<Villager, Villager.Profession>() {
        @NotNull
        @Override
    ...
    public static final MobStyleWrapper<ZombieVillager, Villager.Profession> VILLAGER_ZOMBIE = new MobStyleWrapper<>(ZombieVillager.class, new MobStyleWriter.WriterEnum<ZombieVillager, Villager.Profession>() {
        @NotNull
        @Override
        public Class<Villager.Profession> getEnumClass() {
            return Villager.Profession.class;
        ...
        public boolean alreadyHas(@NotNull ZombieVillager entity, @NotNull Villager.Profession value) {
            return entity.getVillagerProfession() == value;
        }
    });
}
