...
public enum ArenaEditorType implements EditorButtonType {
	...
	REGION_WAVE_CHANGE_TRIGGERS(Material.CLOCK, "Spawn Game Triggers",
		...
		EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
		EditorButtonType.warn("Currently, only WAVE_START trigger is supported."),
		EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
	...
	WAVES_WAVE_CHANGE_MOBS(Material.CREEPER_SPAWN_EGG, "Wave Mobs",
		...
		EditorButtonType.click("Left-Click to &fNavigate")),
	WAVES_WAVE_CHANGE_AMPLIFICATORS(Material.EXPERIENCE_BOTTLE, "Wave Amplificators",
		EditorButtonType.info("A list of amplificators to be applied to the wave mobs. Amplificators allows you to increase waves difficulty during the game after certain game events."),
		EditorButtonType.click("Left-Click to &fNavigate")),
	WAVES_WAVE_MOB_OBJECT(Material.CREEPER_SPAWN_EGG, "Mob: &6" + Placeholders.ARENA_WAVE_MOB_ID,
		EditorButtonType.current("Start Amount: &f" + Placeholders.ARENA_WAVE_MOB_AMOUNT + "\nStart Level: &f" + Placeholders.ARENA_WAVE_MOB_LEVEL + "\nSpawn Chance: &f" + Placeholders.ARENA_WAVE_MOB_CHANCE + "%"),
		EditorButtonType.note("Mob level and amount can be adjusted by the Wave Amplificators."),
		EditorButtonType.click("Left-Click to &fEdit Amount\nRight-Click to &fEdit Level\n[Q] Key to &fEdit Chance\nShift-Right to &fDelete &7(No Undo)")),
	...
	WAVES_WAVE_AMPLIFICATOR_OBJECT(Material.EXPERIENCE_BOTTLE, "Amplificator: &6" + Placeholders.WAVE_AMPLIFICATOR_ID,
		EditorButtonType.info("Mob Level: &f" + Placeholders.WAVE_AMPLIFICATOR_VALUE_LEVEL + "\nMob Amount: &f" + Placeholders.WAVE_AMPLIFICATOR_VALUE_AMOUNT + "\nGame Triggers:\n" + Placeholders.WAVE_AMPLIFICATOR_TRIGGERS),
		EditorButtonType.click("Left-Click to &fEdit\nRight-Click to &fDelete &7(No Undo)")),
	WAVES_WAVE_AMPLIFICATOR_CREATE(Material.ANVIL, "Create Amplificator",
		EditorButtonType.info("Creates a new wave amplificator."),
		EditorButtonType.click("Left-Click to &fCreate")),
	WAVES_WAVE_AMPLIFICATOR_CHANGE_VALUES(Material.COMPARATOR, "Values",
		EditorButtonType.current("Mob Level: &f" + Placeholders.WAVE_AMPLIFICATOR_VALUE_LEVEL + "\nMob Amount: &f" + Placeholders.WAVE_AMPLIFICATOR_VALUE_AMOUNT),
		EditorButtonType.info("Here you set amplificator values, that will be applied to the wave."),
	...
	WAVES_WAVE_AMPLIFICATOR_CHANGE_VALUE_AMOUNT,
	WAVES_WAVE_AMPLIFICATOR_CHANGE_VALUE_LEVEL,
	WAVES_WAVE_AMPLIFICATOR_CHANGE_TRIGGERS(Material.CLOCK, "Amplificator Game Triggers",
		EditorButtonType.current(Placeholders.WAVE_AMPLIFICATOR_TRIGGERS),
		EditorButtonType.info("A list of Game Triggers (Events) when this amplificator will be applied."),
		EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
		EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
