...
public enum ArenaEditorType implements EditorButtonType {
    ...
    ARENA_OPEN_SCRIPT_MANAGER(Material.CHAIN_COMMAND_BLOCK, "Arena Script Manager",
        EditorButtonType.info("A list of all the arena scripts. There you define the main behavior of your arna."),
        //EditorButtonType.warn("Please ensure there are no problems:\n" + Placeholders.GENERIC_PROBLEMS),
        EditorButtonType.click("Left-Click to &fNavigate")),
    ...
    REGION_CREATE(Material.ANVIL, "Create a Region",
        ...
        EditorButtonType.click("Left-Click to &fCreate")),
    @Deprecated REGION_OPEN_CONTAINERS(Material.CHEST, "Region Containers",
        ...
        EditorButtonType.click("Left-Click to &fNavigate")),
    @Deprecated REGION_OPEN_WAVES(Material.BLAZE_POWDER, "Region Waves",
    ...
    REGION_CHANGE_DEFAULT(Material.GRASS_BLOCK, "Region Default",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated REGION_CHANGE_LINKED(Material.STRING, "Linked Regions",
    ...
    REGION_CHANGE_NAME(Material.NAME_TAG, "Region Name",
        ...
        EditorButtonType.click("Left-Click to &fEdit")),
    @Deprecated REGION_CHANGE_TRIGGERS_LOCKED(Material.CLOCK, "Region Lock Triggers",
    ...
    @Deprecated REGION_CHANGE_TRIGGERS_UNLOCKED(Material.CLOCK, "Region Unlock Triggers",
    ...
    REGION_CONTAINER_CHANGE_ITEMS(Material.CHEST, "Items Content",
        ...
        EditorButtonType.click("Left-Click to &fNavigate")),
    @Deprecated REGION_CONTAINER_CHANGE_REFILL_TRIGGERS(Material.CLOCK, "Refill Game Triggers",
    ...
    @Deprecated REGION_WAVE_OBJECT(Material.BLAZE_POWDER, "Wave: &6" + Placeholders.REGION_WAVE_ID,
        EditorButtonType.info("Contains Arena Waves:\n&a" + Placeholders.REGION_WAVE_WAVE_IDS),
        EditorButtonType.click("Left-Click to &fEdit\nShift-Right to &fDelete &7(No Undo)")),
    @Deprecated REGION_WAVE_CREATE(Material.ANVIL, "Create Region Wave",
        EditorButtonType.info("Creates a new region wave."),
        EditorButtonType.click("Left-Click to &fCreate")),
    @Deprecated REGION_WAVE_CHANGE_ID(Material.MAP, "Arena Wave Ids",
    ...
    @Deprecated REGION_WAVE_CHANGE_SPAWNERS(Material.SPAWNER, "Wave Spawners",
    ...
    @Deprecated REGION_WAVE_CHANGE_SPAWNERS_ADD,
    @Deprecated REGION_WAVE_CHANGE_TRIGGERS(Material.CLOCK, "Spawn Game Triggers",
    ...
    GAMEPLAY_CHANGE_MCMMO_ALLOWED(Material.DIAMOND_SWORD, "mcMMO",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated GAMEPLAY_CHANGE_AUTO_COMMANDS(Material.DAYLIGHT_DETECTOR, "Auto-Commands",
    ...
    @Deprecated GAMEPLAY_AUTO_COMMAND_OBJECT(Material.COMMAND_BLOCK, "Auto-Command",
        EditorButtonType.info("Target: &f" + Placeholders.GAME_COMMAND_TARGET + "\nGame Triggers:\n" + Placeholders.GAME_COMMAND_TRIGGERS),
        EditorButtonType.click("Left-Click to &fEdit\nShift-Right to &fDelete &7(No Undo)")),
    @Deprecated GAMEPLAY_AUTO_COMMAND_CREATE(Material.ANVIL, "Create an Auto-Command",
        EditorButtonType.info("Create a new auto-command executor."),
        EditorButtonType.click("Left-Click to &fCreate")),
    @Deprecated GAMEPLAY_AUTO_COMMAND_CHANGE_TRIGGERS(Material.CLOCK, "Game Triggers",
        ...
        EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
        EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
    @Deprecated GAMEPLAY_AUTO_COMMAND_CHANGE_TARGET_TYPE(Material.ARMOR_STAND, "Target Type",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated GAMEPLAY_AUTO_COMMAND_CHANGE_COMMANDS(Material.MAP, "Commands",
    ...
    @Deprecated WAVES_WAVE_AMPLIFIER_OBJECT(Material.EXPERIENCE_BOTTLE, "Amplifier: &6" + Placeholders.WAVE_AMPLIFIER_ID,
        ...
        EditorButtonType.click("Left-Click to &fEdit\nRight-Click to &fDelete &7(No Undo)")),
    @Deprecated WAVES_WAVE_AMPLIFIER_CREATE(Material.ANVIL, "Create Amplificator",
        EditorButtonType.info("Creates a new wave amplifier."),
        EditorButtonType.click("Left-Click to &fCreate")),
    @Deprecated WAVES_WAVE_AMPLIFIER_CHANGE_VALUES(Material.COMPARATOR, "Values",
    ...
    @Deprecated WAVES_WAVE_AMPLIFIER_CHANGE_VALUE_AMOUNT,
    @Deprecated WAVES_WAVE_AMPLIFIER_CHANGE_VALUE_LEVEL,
    @Deprecated WAVES_WAVE_AMPLIFIER_CHANGE_TRIGGERS(Material.CLOCK, "Amplifier Game Triggers",
    ...
    REWARD_CREATE(Material.ANVIL, "Create Reward",
        ...
        EditorButtonType.click("Left-Click to &fCreate")),
    @Deprecated REWARD_CHANGE_TRIGGERS(Material.CLOCK, "Reward Game Triggers",
    ...
    REWARD_CHANGE_LATE(Material.IRON_DOOR, "Is Late",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated REWARD_CHANGE_TARGET_TYPE(Material.ARMOR_STAND, "Target Type",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated REWARD_CHANGE_CHANCE(Material.COMPARATOR, "Chance",
    ...
    SHOP_CHANGE_ACTIVE(Material.REPEATER, "Is Active",
        ...
        EditorButtonType.click("Left-Click to &fToggle")),
    @Deprecated SHOP_CHANGE_TRIGGERS_LOCKED(Material.CLOCK, "Shop Lock Triggers",
        ...
        EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
        EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
    @Deprecated SHOP_CHANGE_TRIGGERS_UNLOCKED(Material.CLOCK, "Shop Unlock Triggers",
    ...
    @Deprecated SHOP_CATEGORY_CHANGE_TRIGGERS_LOCKED(Material.CLOCK, "Category Lock Triggers",
        ...
        EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
        EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
    @Deprecated SHOP_CATEGORY_CHANGE_TRIGGERS_UNLOCKED(Material.CLOCK, "Category Unlock Triggers",
    ...
    SHOP_PRODUCT_CHANGE_COMMANDS(Material.COMMAND_BLOCK, "Commands",
        ...
        EditorButtonType.click("Left-Click to &fAdd Command\nShift-Right to &fClear List")),
    @Deprecated SHOP_PRODUCT_CHANGE_TRIGGERS_LOCKED(Material.CLOCK, "Product Lock Triggers",
        ...
        EditorButtonType.note("Detailed information about Game Triggers is on the plugin wiki."),
        EditorButtonType.click("Left-Click to &fAdd Trigger\nRight-Click to &fClear List")),
    @Deprecated SHOP_PRODUCT_CHANGE_TRIGGERS_UNLOCKED(Material.CLOCK, "Product Unlock Triggers",
        EditorButtonType.current(Placeholders.SHOP_PRODUCT_TRIGGERS_LOCKED),
    ...
    @Deprecated SPOT_STATE_CHANGE_TRIGGERS,
