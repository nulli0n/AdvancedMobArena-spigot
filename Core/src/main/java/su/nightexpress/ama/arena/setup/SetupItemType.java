...
public enum SetupItemType implements EditorButtonType {
    ...
    REGION_CONTAINER(Material.CHEST, "Region Container Tool",
        EditorButtonType.info("Places/Creates a region container at a clicked chest."),
        EditorButtonType.click("Left-Click to &fDestroy/Remove\nRight-Click to &fPlace/Create")),
