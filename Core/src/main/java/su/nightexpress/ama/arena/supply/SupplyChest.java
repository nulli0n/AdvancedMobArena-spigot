...
import su.nightexpress.ama.arena.editor.supply.SupplySettingsEditor;
...
public class SupplyChest implements ArenaChild, Placeholder {
    ...
    private SupplySettingsEditor editor;

    public SupplyChest(@NotNull ArenaConfig arenaConfig, @NotNull String id) {
    ...
    @NotNull
    public SupplySettingsEditor getEditor() {
        if (this.editor == null) {
            this.editor = new SupplySettingsEditor(this.plugin, this);
        }
        return editor;
    }
