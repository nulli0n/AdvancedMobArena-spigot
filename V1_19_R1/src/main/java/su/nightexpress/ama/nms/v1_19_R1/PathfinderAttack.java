package su.nightexpress.ama.nms.v1_19_R1;
...
public class PathfinderAttack extends Goal {
    ...
    public boolean canContinueToUse() {
        ...
        return this.entity.isWithinRestriction(new BlockPos(target.getX(), target.getY(), target.getZ()));
    }
